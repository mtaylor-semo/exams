...
\question[10]
You are charged with designing a bird sanctuary across a landscape. Describe how you will you patch dynamics (5 pts) and stepping stones (5 pts) to maximize the number of species protected by your sanctuary. Be sure to clearly state the purpose of each of these three components.
%
%\question[15]
