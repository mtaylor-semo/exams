...
\question
During migration, birds navigate by all of the following mechanisms \emph{except one.} Which one?
\begin{choices}
	\choice Geomagnetism.
	\correctchoice GPS.
...
\question[5]
\begin{multicols}{2}
Will a small bird adapted to specific wetland habitats (such as a Prothonotary Warbler) have a greater extinction threat from habitat loss or predation/persecution? (2 pts). Explain why. (3 pts)
\columnbreak
...
\AnswerBox{0.6\textheight}{Waterfowl habitat and stopping insecticide}


\bonusquestion[3]
Suggest one (or more) improvements to this course.
