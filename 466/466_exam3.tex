...
\question[10]
The migratory routes of many seabirds that migrate between the two hemispheres show a figure-8 pattern. Explain why in terms of high and low pressure systems in each hemisphere.
