...
\part[5]
Explain why the range size for almost none of the mammals falls below the diagonal dashed line. 
...
\ifprintanswers \textbf{Small geographic range size.} \fi
...
\question[10]
Stevens (1996) tested whether Pacific coastal fishes followed Rapoport's Rule. His results (below left) were consistent with the rule. Smith and Gaines (2003) analyzed Stevens' data in a different way.  Smith and Gaines got different results than Gaines. One part of their results is shown below right. Comparing the two figures below, explain how the results of Smith and Gaines differed from Stevens for range size and richness at it relates to Rapoport's Rule.
\begin{center}
