...
\question[2]
From when to when (years ago) did the Pleistocene occur?

\AnswerBox{2\baselineskip}{2.6 \textsc{mya} -- 12 \textsc{kya}}
...
\begin{multicols}{2}
What is the \emph{most likely} distribution of the five families of freshwater crabs shown at right?
