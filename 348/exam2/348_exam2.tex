...
%\question[2]
%How many atmospheres of pressure does a squid living 670 meters deep in the Pacific Ocean experience?
...
%\question[2]
%A squid at 670 m depth experiences~\ifprintanswers\quad\textbf{68}\quad\else\rule{2cm}{0.4pt}\fi~atmospheres of pressure.
...
Clay (\textless 0.004 mm), silt (0.062–0.004 mm), sand (2–0.062 mm) Clay and silt = mud.} 
...
Mobile-scavenger stage - nektonic organisms discover the carcass and consume the flesh. \bigskip

Reef stage - Skeleton provides structure for sessile organisms. Begins after scavenger stage. \bigskip

Enrichment opportunist stage - Nutrients from the whale seep into the sediment, enriching it. Supports aerobic organisms. \bigskip

Sulphophilic stage - Sediment becomes anaerobic, supports invertebrates and bacteria that oxidize H\textsubscript{2}S.
...
%\bonusquestion[2]
\question[2]
Name one type of organism other than hermatypic corals that contribute to reef building. I will \emph{only} grade the first term I see, so don't make a list. Choose wisely.
...
\question[10]
Name and describe the two long-term alternate stable states that occur between kelp and sea urchins. Include the reasons one state changes to the other, and the conditions that favor the maintenance of each state.
...
\question
	...
	\part[10]
%	Describe how light, aerial exposure, and wave action interact to determine the types of hermatypic corals (relative size, branching, etc.) present in each zone of a fringing reef.
	Describe the three stages in order that form the basic model of atoll formation for coral reefs. Be sure you clearly distinguish how each successive stage is different from the prior stage.
