...
\AnswerBox{\baselineskip}{Sand, silt, clay}

\question[10]
Name \emph{in order} and briefly explain the three stages of succession for community development associated with whale fall. Another stage overlaps the other three stages so the order of it does not matter but you must still explain what occurs during that stage.
...
\question[10]
Name and describe the two long-term alternate stable states that occur between kelp and sea urchins.
...
\question
	...
	\part[10]
	Describe how light, aerial exposure, and wave action interact to determine the types of corals (relative size, branching, etc.) present in each zone.
