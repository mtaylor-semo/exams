...
\footer{\iflastpage{\small Have a great summer!}{}}{}{\iflastpage{\small \rule{0.6in}{0.4pt} / \numpoints\ points}{}}%{\makebox[0.75in]{\hrulefill}}
...
\question[5]
Explain whether the amount of iron recycled in the Antarctic by toothed whales (e.g., Killer Whale) would be higher or lower compared to baleen whales (e.g., Blue Whales). Justify your answer.

\AnswerBox{0.2\textheight}{Reduced. More trophic levels.}

\question[5]
Tell whether the results shown in the following figure support the predation risk hypothesis or the visual acuity hypothesis. Explain why.

\includegraphics[width=\textwidth]{exam4_visual_acuity}

\AnswerBox{0.2\textheight}{Visual acuity. Sharks were more successful when it was a new moon because the visual acuity of prey was reduced.}
...
\question[10] \label{q:carbonate_buffering_system}
...
recruitment and growth (indicated by the black arrow), distance between patches and coral fecundity. Be sure to include both positive (dashed lines) and negative (solid lines) relation among these factors. Do not include unnecessary factors and relationships. 
