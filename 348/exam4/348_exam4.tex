...
\firstpageheader{Marine Biology, Exam 4, S\short{\year}.}{}{%
...
\question[2]
Name the type of bubbles that snapping shrimp and mantis shrimp use to stun their prey.

\AnswerBox{0.1\textheight}{Cavitation}

\question[4]
Name two types of reproduction (giving birth) in sharks.

\AnswerBox{0.1\textheight}{Oviparity, ovoviviparity, viviparity.}

\question[4]
Name two ways that sponges can reproduce asexually.

\AnswerBox{0.1\textheight}{Fragmentation, gemmules, budding.}
...
\textbf{Modify figure to turn red (or green) lines into dashed lines so can be distinguished in pring.}

\textbf{Remove dashe boxes so no confusion with dashed lines. Not relevant to question asked. COuld make
	gray-filled boxes if necessary.}
