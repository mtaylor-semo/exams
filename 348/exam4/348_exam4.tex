...
\question[2] % Questions from Emma VanDeven's honors presentation.
What is the approximate percent similarity between all Brucella species (your answer should be ±2\%) 

\AnswerBox{0.05\textheight}{97\%.}

\question[3]
What is attributed to cause host specialization between Brucella species?

\AnswerBox{0.05\textheight}{Pseudogenes}

\question[5]
Briefly explain why marine \textit{Brucella} species are considered non-zoonotic? 

\AnswerBox{0.2\textheight}{A zoonosis is a disease that can be transmitted from animals to humans. Diseases caused by marine \textit{Brucella} are not transmissible to humans.}
