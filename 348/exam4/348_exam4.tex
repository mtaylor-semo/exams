...
\question[5] % Questions from Grace Barlage's presentation.
What would the resulting sex of green sea turtle hatchlings be if the temperature of the nesting
area was found to be 35°C? Would the eggs or hatchlings be viable? Explain your reasoning.

\AnswerBox{0.1\textheight}{The pivotal temperature is about 29°C. If this temperature is constant, then a 50:50 sex ratio results. Above 29°C produces mostly females. The optimum thermal
range for successful incubation is 25-33°C. Therefore, 35°C could cause poor embryo development and increased embryo mortality. The high
temperature would also reduce oxygen availability and reduce muscle coordination, inhibiting
the ability to crawl out of the nest. If the embryos did not die due, then
hatchlings would be more susceptible to predation. Overall, high temperatures would severely
decrease the hatchling viability.
.}

\question[5] % Alexandra Eaton's presentation
Orca mother-infant pairs have side biases. What side of the mother did the infant prefer when a boat approached the pair? What was the explanation given for this preference?

\AnswerBox{0.1\textheight}{The infant goes to the mother's left side similarly when a predator approaches
the pair. The mother sees the boat as a threat, causing the shift of the infant to the left
side. The left position improves the flow of sensory information to the partner.}

\question[5] % Frank Irovic's presentation
Explain why establishing a specific protected zone for eider ducks may not be effective in regions with
high environmental variability. 

\AnswerBox{0.1\textheight}{The answer should essentially be something focusing on the idea that as the environment
changes from year-to-year necessary things such as food resources may shift location and no
longer be in the protected zone. This effectively makes the protected zone useless as it no
longer covers the organisms or resources that need that protection.}
...
\question[10]
 Based on the graphs above, tell how acidification will likely affect primary production. Explain why bleaching will lead to this change.
