...
\question[4]
You learned the deepest point in each ocean. List the three \emph{shallowest} points (e.g., trenches), from shallow to deep, and the ocean in which each point is located. 1/2 point per blank plus 1 point for the correct order.
...
\vspace{0.5\baselineskip}
	...
	\begin{tabular}{rll}
		...
		\makebox[6cm][l]{\ifprintanswers\textbf{Indian}\else \hrulefill \fi} \\[4ex]
		%
		Most deep: &
		\makebox[6cm][l]{\ifprintanswers\textbf{Sandwich}\else\hrulefill \fi} &
		\makebox[6cm][l]{\ifprintanswers\textbf{Southern Ocean}\else \hrulefill \fi} \\
	\end{tabular}
...
\begin{parts}
	...
	\part[6] Describe ridge push and how it contributes to the movement of tectonic plates.
	...
	\part[6] Describe slab pull and how it contributes to the movement of tectonic plates. 
