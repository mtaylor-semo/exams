...
\question[4]
You learned the deepest point in each ocean. List the three \emph{shallowest} points (e.g., trenches) and the ocean in which each point is located. Circle the deepest of the three you list. 1/2 point per blank plus 1 point for the circle.
