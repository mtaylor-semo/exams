...
\question[2]
Relative to oceanic crust, continental crust is
\begin{choices}
\choice younger, denser, and thinner.
\correctchoice older, less dense, and thicker.
\choice younger, less dense, and thicker.
\choice older, less dense, and thinner.
\choice older, denser, and thinner.
\choice younger, denser, and thicker.
\end{choices}

\question[2]
Slab pull occurs when
\begin{choices}
	\choice Oceanic crust subducts near oceanic ridges.
	\choice Continental crust subducts belong oceanic crust.
	\correctchoice Oceanic crust subducts below continental crust.
	\choice Continental crust of one plate pulls away from continental crust of the adjacent plate.
	\choice Oceanic crust of one plate pulls away from oceanic crust of the adjacent plate.
	\choice Adjacent plates subduct away from each other, regardless of crust type.
\end{choices}

\question[2]
Ekman transport occurs when
\begin{choices}
	\correctchoice wind causes water to move 90° relative to the direction of wind.
	\choice wind causes water to move 45° relative to the direction of wind.
	\choice currents bend to right in the northern hemisphere.
	\choice currents bend to left in the northern hemisphere.	
	\choice wind causes water to move in the same direction as the wind.
\end{choices}

\question[2]
Organisms that spend their entire life as free-swimming organisms moving under their own power are
\begin{choices}
	\correctchoice holonektonic.
	\choice meroplanktonic.
	\choice holoplantonic.
	\choice meronektonic.
	\choice nektotrophic.
	\choice planktotrophic.
\end{choices}
