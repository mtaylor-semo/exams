...
\firstpageheader{{\fontsize{16pt}{18pt}\selectfont Marine Biology, Exam 1, Sp\short{\year}, \numpoints~points.}}{}{%
	\ifprintanswers\textbf{KEY}\else {\fontsize{16pt}{18pt}\selectfont Name: \enspace Sara Schulte}\fi}
...
D. \ifprintanswers\makebox[5cm][l]{\textbf{Abyssalpelagic}}\else\makebox[5cm][l]{\hrulefill}\fi\quad%
E. \ifprintanswers\makebox[5cm][l]{\textbf{Hadalpelagic}}\else\makebox[5cm][l]{\hrulefill}\fi
%
...
\question[10]
See of figure of Africa in separate handout.\vspace{\baselineskip}
...
\newpage
	...
	\part[5]
	(Snaggletooth, con't.) Identify a different adaptation, other than bioluminescence and \emph{visible in the image}, that is specific to life in the deep-sea (this adaptation can be common to deep sea organisms regardless of depth zone). Explain how that adaptation is related to the environment or survival in the deep-sea. %Do not use bioluminescence.
...
\AnswerBox{0.5\baselineskip}{Nothing. No light.}
