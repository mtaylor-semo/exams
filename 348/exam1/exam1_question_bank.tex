...
\question[5]
List the three deepest ocean trenches, from shallowest to deepest, and the ocean basin in which each is located.  Extra Credit: List the depth, within 100 feet / 30 meters, of each trench you list. 0.5 point per trench. Be sure to indicate whether you are using feet or meters.

\vspace{\baselineskip}

	\begin{tabular}{rll}
		\large Trench Name		&	\large Ocean Basin	&	\large Depth \small(extra credit) \\[4ex]
		\makebox[6cm][l]{\hrulefill} & \makebox[6cm][l]{\hrulefill} & \makebox[4cm][l]{\hrulefill} \\[45ex]
		\makebox[6cm][l]{\hrulefill} & \makebox[6cm][l]{\hrulefill} & \makebox[4cm][l]{\hrulefill}\\[4ex]
		\makebox[6cm][l]{\hrulefill} & \makebox[6cm][l]{\hrulefill} & \makebox[4cm][l]{\hrulefill} \\
	\end{tabular}

%% Three point version, no extra credit.
\question[3]
List the three deepest ocean trenches, from shallowest to deepest, and the ocean in which each trench is located.  1/2 point per blank plus 1 point for the correct order. 
...
\begin{tabular}{rll}
	...
	%
	Most shallow: &
	\makebox[5cm][l]{\ifprintanswers\textbf{Marianas/Challenger Deep}\else \hrulefill \fi} &
	\makebox[5cm][l]{\ifprintanswers\textbf{Pacific}\else \hrulefill \fi} \\[4ex]
	%
	&
	\makebox[5cm][l]{\ifprintanswers\textbf{Puerto Rico}\else\hrulefill \fi} &
	\makebox[5cm][l]{\ifprintanswers\textbf{Atlantic}\else \hrulefill \fi} \\[4ex]
	%
	Most deep: &
	\makebox[5cm][l]{\ifprintanswers\textbf{Sunda/Diamantina}\else \hrulefill \fi} &
	\makebox[5cm][l]{\ifprintanswers\textbf{Indian}\else \hrulefill \fi} \\
\end{tabular}
...
\question[5] % Show a picture of a clearly burrowing organism or a clearly attached to rock species.
Tell whether the organism shown on screen is more likely to be found on an active or passive margin. Explain why.


\question[5]
Why do meroplanktonic and meroepipelagic \emph{not} mean the same thing (not synonymous)?

\AnswerBox{Some meroplankton have adults that are benthic, not nektonic. Thus, they do not spend part of their life in the epipelagic.}
