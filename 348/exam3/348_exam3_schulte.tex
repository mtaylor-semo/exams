...
\bonusquestion
Write the name of your favorite band or musical artist. (2 pts extra credit)
...
\question[15]
Meiofauna refers to the small animals that live between sediment grains. Describe how the relative size (larger, smaller, etc.) of the meiofauna will change in a bar-built estuary from the river to the sand bar at the ocean. Tell why the size of the meiofauna changes.
...
\question[15]
Explain how physical and competitive forces interact to explain zonation of the four major marsh plant species in a New England marsh.
