...
\question[4]
Name the tidal pattern displayed in the graph below (next question), and tell how you know. The tides shown go from the first low tide of 01 September to the last low tide of 15 September.
...
%
\fullwidth{
\includegraphics[width=\linewidth]{tidal_plot_arena_cove}}

\AnswerBox{0.01\textheight}{Mixed semi-diurnal. Two high and two low with very unequal heights}
...
\AnswerBox{0.4\textheight}{Competition has strong comp and affected by post-recruitment processes. Recruitment limitation has weak comp and not modified by post-recruitment.}
...
\question[9]
Last night was a half moon (third quarter). Tell whether that phase would have caused a neap tide or a spring tide, then diagram and explain why.
...
\question[15]
Describe (compare and contrast) how light, aerial exposure, and wave action interact to determine the types of hermatypic corals (relative size, branching, etc.) present on a reef flat and on the fore-reef slope. 
