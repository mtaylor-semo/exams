...
What is the probability that a new, neutral mutation will drift to fixation in a population?  Express this answer as a fraction.  You need write nothing but the fraction.
	...
	\AnswerBox{\baselineskip}{\Large $\frac{1}{2N_e}$}
	%\ifprintanswers{\LARGE$\frac{1}{2N_e}$}\fi\vspace*{\stretch{0.05}}

%\fullwidth{(1 pt extra credit) Which Hardy-Weinberg assumption have we not yet studied?}\ifprintanswers\quad\textbf{Random Mating}\fi%\vspace*{\stretch{0.05}}

\newpage

\question[10]
Fill in the following table with the correct genotype and allele frequencies based on this survey of 725 plants. 251 individuals had red flowers, 351 individuals had pink flowers (heterozygotes), and 123 individuals had white flowers. The population is in \textsc{hwe}. \emph{Show your work! Round to three digits after the decimal.}
...
\midrule
 & \\[0.2em]
$p$		& \ifprintanswers \textbf{0.588} \else \rule{1in}{0.4pt} \fi\\[1.5em]
$q$		& \ifprintanswers \textbf{0.412} \else \rule{1in}{0.4pt} \fi\\[1.5em]
$p^2$	& \ifprintanswers \textbf{0.346} \else \rule{1in}{0.4pt} \fi\\[1.5em]
$2pq$	& \ifprintanswers \textbf{0.484} \else \rule{1in}{0.4pt} \fi\\[1.5em]
...
\question[5]
Name the mode of selection that describes how the phenotype would change if the fitness for the three genotypes  is $B_1B_1$ = 0.96, $B_1B_2$ = 0.98, and $B_2B_2$ = 1. Tell how you know.
