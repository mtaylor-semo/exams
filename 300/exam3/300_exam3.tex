...
\AnswerBox{0.1\textheight}{a. End Permian; b. End K/T; End Ordo, Late Devo, End Tria.}
...
\question[10]
Explain how ecological specialization might contribute to the evolution of taxa with high turnover rates. (10 pts; I presented this hypothesis intertwined with two other hypotheses but explained how the three are intertwined. You may explain ecological specialization alone or in the context of the other two hypotheses.)
...
\question[5]
Briefly explain the effects of Muller's Ratchet in asexually reproducing species.
...
\question[10]
Male swordtail characin fishes (\textit{Corynopoma riisei}) have a long, narrow extension of the gill cover. The extension has a ``flag'' on the tip, which mimics the fish's prey. The male uses the flag to lure females to the male for mating. A study by Arnqvist and Kolm (2010) showed that the shape of the flag was strongly correlated with environmental variables like prey availability. Based on this information, answer the next two questions.}
	\begin{parts}
	\part[5]
