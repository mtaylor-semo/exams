...
Each circle represents one allele. Letter codes inside each circle is the sample site shown along the coast. Each line connecting two circles indicates one mutation difference between alleles.  Small dashes circles additional mutational differences between alleles.
