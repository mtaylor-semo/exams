...
\begin{enumerate}[label=\alph*.]
	\item Largest: \ifprintanswers \textbf{Permian} \fi \vspace*{1\baselineskip}
	
	\item Most recent: \ifprintanswers \textbf{Cretaceous} \fi  \vspace*{1\baselineskip}
	
	\item One other: \ifprintanswers \textbf{Ordo, Dev., Triassic} \fi  \vspace*{1\baselineskip}
\end{enumerate}

\part[2] 
What is the common, underlying cause of all five mass extinctions that have occurred since the Cambrian.

\AnswerBox{0.01\textheight}{Climate Change}
\end{parts}

\question[5]
Briefly explain the effects of Muller's Ratchet in asexually reproducting species.

\AnswerBox{0.2\textheight}{%
	Muller's ratchet is the accumulation of deleterious mutations in asexually reproducing species (2 pts). There is no way for asexually reproducing species to get rid of deleterious mutations (2 pts).
}
...
\question[10]
Explain the Red Queen hypothesis. Explain how it relates to the evolution of 
love darts in the hermaphroditic land snail, \textit{Cantareus aspersus}.

%sexual reproduction as a defense against parasites.

\AnswerBox{0.3\textheight}{%
	Red Queen Hypothesis suggests that the hermaphroditic snails evolve in response to each other. Snails that are better dart shooters may alter the reproductive physiology of the other individual. Thus, the other individual evolves the ability to resist the allohormones of the first individual.
}
