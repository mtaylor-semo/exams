...
\AnswerBox{0.25\textheight}{Thermoregulation, predator/prey detection, freeing of hands.}
...
\question[5]
Briefly explain Muller's Ratchet.
...
\question[5]
Explain the Red Queen hypothesis as it relates to the evolution of sexual reproduction as a defense against parasites.
...
%
\question[5]
Explain the “Replacement Hypothesis" for the migration of early \textit{Homo} into Asia and Europe, and the evidence that supports this hypothesis.

\AnswerBox{0.3\textheight}{Later wave of migration out of Africa replaced earlier waves. DNA lineages in European and Asian is “younger” that extant Africa lineages.}


\question[10]
The grasses (Poaceae, includes rice and corn) produce flowers that lack petals and sepals. Given the three classes of \textsc{mads} genes below, which class or classes most likely had a mutation or change in expression that caused the loss of petals and sepals? Explain why, using the \textsc{abc} model of floral development. Class \textsc{a}: Apetala1. Class \textsc{b}: Apetala3. Class \textsc{c}: Agamous.
