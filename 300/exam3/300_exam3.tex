...
\question[5]
List three of the five major mass extinctions that have occurred since the Cambrian.  Indicate which event was the largest and which event is the most famous.

\begin{enumerate}[label=\alph*.]
	\item \ifprintanswers \textbf{Permian (Largest)} \fi \vspace*{1\baselineskip}
	
	\item \ifprintanswers \textbf{Cretaceous (Famous)} \fi  \vspace*{2\baselineskip}
	
	\item \ifprintanswers \textbf{Ordo, Dev., Triassic} \fi  \vspace*{2\baselineskip}
...
\question[5]
Explain the common, underlying cause of all five mass extinctions that have occurred since the Cambrian.

\AnswerBox{0.25\textheight}{Climate change.}

\question[5]
Tell whether lekking in Greater Prairie Chickens increases or decreases $N_e$. Explain why.


\AnswerBox{0.3\textheight}{Decreases $N_e$. Fewer males in the population are actually breeding because females are choosing among the various males.}
...
\question[5]
Explain the Red Queen hypothesis as it relates to the evolution of 
