...
\question[11]
Use the phylogeny of living fishes on the last page of this exam (you may tear it off) to fill in the blanks below with the appropriate systematic group name and classification level (class, subclass, etc.).  Each lettered blank below corresponds to the lettered branch on the phylogeny. ($1/2$ point per blank). Spelling counts throughout.\vspace{0.5\baselineskip}
...
\noindent This page intentionally left blank so that you can tear off the phylogeny on the next page. Turn in the phylogeny with your exam.
