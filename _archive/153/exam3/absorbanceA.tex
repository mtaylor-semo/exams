...
\ifprintanswers{\textbf{chlorophyll}}\fi\vspace*{2\baselineskip}

\question
Line B represents the absorption spectrum of which group of photopigments?
\ifprintanswers{\textbf{phycobilins}}\fi\vspace*{2\baselineskip}

\question
Line C represents the absorption spectrum of which group of photopigments?
\ifprintanswers{\textbf{carotenoids}}\fi\vspace*{2\baselineskip}
