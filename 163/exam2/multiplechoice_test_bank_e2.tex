...
%BeginMC
\question
A rock sample contains an isotope that has a half-life of 50 million years. The sample contains 25\% of the parent element and 75\% of the daughter element. How old is the sample? \textbf{FINISH}
...
%BeginMC
\question
Which of the six numbered marks in the hypothesis corresponds to the most recent common ancestor of a mushroom and a sponge?
\begin{multicols}{2}
...
%BeginMC
\question
Phylogenetic trees often represent small subsets of larger phylogenetic trees. Compare the smaller phylogenies (1--4) to the larger phylogeny, then pick which of the smaller phylogenies shows a pattern of relationships that is not consistent with the pattern shown by the larger phylogeny.
\begin{multicols}{2}
...
\columnbreak
	...
	\includegraphics[width=0.35\textwidth]{exam1_tree3a}
\end{multicols}

\includegraphics[width=\textwidth]{exam1_tree3b}
%EndMC
...
\begin{choices}
\correctchoice phylogenetic relatedness of birds and dinosaurs.   %EndChoice
\choice contention that birds are much older than we originally thought.   %EndChoice
\choice claim that birds evolved feathers before dinosaurs.   %EndChoice
