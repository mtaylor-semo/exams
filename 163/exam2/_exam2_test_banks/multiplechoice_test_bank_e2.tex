...
%BeginMC
\question
A rock sample contains an isotope that has a half-life of 42 million years. The sample contains 3.125\% of the parent element and 96.875\% of the daughter element. How many millions of years old is the sample?
...
\begin{multicols}{2}
	\begin{choices}
		...
		\choice 126. %dontshuffle %EndChoice
		\choice 168. %dontshuffle %EndChoice
		\correctchoice 210. %dontshuffle %EndChoice
		\choice 252. %dontshuffle %EndChoice
	\end{choices}
...
\begin{multicols}{2}
\begin{choices}
\choice \includegraphics[width=0.25\textwidth]{exam1_small_treeA} %don'tshuffle %EndChoice
\choice \includegraphics[width=0.25\textwidth]{exam1_small_treeB} %don'tshuffle %EndChoice
\choice \includegraphics[width=0.25\textwidth]{exam1_small_treeC} %don'tshuffle %EndChoice
\correctchoice \includegraphics[width=0.25\textwidth]{exam1_small_treeD} %don'tshuffle %EndChoice
\end{choices}
\end{multicols}
%EndMC
...
\begin{multicols}{2}
	...
	\begin{choices}
		\choice a. %dontshufftle %EndChoice
		\choice b. %dontshufftle %EndChoice
		\choice c. %dontshufftle %EndChoice
		\correctchoice d. %EndChoice
	\end{choices}
