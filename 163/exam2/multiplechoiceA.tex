...
\question
\begin{multicols}{2}
The figure at right shows the average number of pollen grains remaining on \textit{Aquilegia pubescens} columbines after visits by hawkmoths. Control flowers had normal length spurs. Shortened flowers had spurs that were cur short and tied by the researchers. Based on the figure, tell which, if any, type of reproductive isolation is supported by the data. 
...
\choice The figure does not provide support for the above types reproductive isolation. %dontshuffle
\end{choices}
...
\end{choices}
	...
	\hfil \includegraphics[width=0.35\textwidth]{exam1_tree3a}\hfill
\end{multicols}
...
\begin{choices}
\choice 16,000 years ago. %dontshuffle 
\choice 60,000 years ago. %dontshuffle
\correctchoice 200,000–300,000 years ago.%dontshuffle 
\choice 1.6 million years ago. %dontshuffle
\choice 6 million years ago. %dontshuffle
\end{choices}
