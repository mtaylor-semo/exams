...
\question\TFQuestion{T}{The results of an experiment must agree with the prediction to support the hypothesis.}
...
\question\TFQuestion{F}{Adaptations evolve as the the result of descent with modification.}
...
\question\TFQuestion{F}{Natural selection acts on the population, not individuals.}
...
\question\TFQuestion{F}{Evolution is genetic change in individuals over time}. 
